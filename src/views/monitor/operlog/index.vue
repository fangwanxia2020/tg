    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          size="mini"
          @click="resetQuery"
          v-hasPermi="['monitor:operlog:reset']"
        >重置</el-button>
      </el-form-item>
    </el-form>
      ...
      >
        ...
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleClean"
            v-hasPermi="['monitor:operlog:removes']"
          >清空</el-button>
        </el-col>
        <!-- <el-col :span="1.5">
        <el-button
    ...
    >
      <template v-slot:operation="scope">
        <el-button
          ...
          v-hasPermi="['monitor:operlog:details']"
        >详细</el-button>
      </template>
    </ty-table>
    <!-- 操作日志详细 -->
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      list(this.addDateRange(sendData, this.dateRange)).then(response => {
    ...
    handleClean() {
      let _this = this;
      this.$confirm('是否确定清空所有查询结果?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(function() {
        return cleanOperlog();
        // return removeOperlog(_this.addDateRange(_this.queryParams, _this.dateRange));
      }).then(() => {
        _this.resetQuery();
