<template>
  <div>
    <ty-business-crud
      ...
      :columns="columns"
      :showSearchFields="['belongEntId','purchaseNo','productionState','originalNo','supplierName']"
      :showOperation="[]"
      title=""
...
export default {
  ...
  methods: {
    ...
    goExamineDetails(row) {
      // console.log(row)
      this.$router.push({
        path: "/examineManage/examineDetails",
        query: {
