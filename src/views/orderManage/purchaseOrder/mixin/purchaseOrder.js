...
export const purchaseOrderMixin = {
  ...
  created() {
    ...
    // console.log("this.$store.getters.parentOrgId456", this.$store.getters.parentOrgId)
    // this.getCgCode()
    this.getUserInfo();
    this.getDeptList();
  ...
  methods: {
    ...
    async totalBtn() {
      ...
      // console.log("1111111111this.dataObj", dataObj)
