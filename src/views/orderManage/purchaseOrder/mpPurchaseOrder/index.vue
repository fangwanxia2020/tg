<template>
  <div class="cy-purchase">
    <ty-business-crud
      ...
      ref="purchaseCrud"
      v-hasListPermi="{
        permiFlag: 'order:mpPurchaseOrder:list',
        column: 'columns',
      }"
    >
      <template
      ...
      >
        <el-button
          ...
          v-hasPermi="['order:mpPurchaseOrder:list:relationOrder']"
        >关联订单</el-button>
      </template>
      <div slot="operator">
        <el-button
          ...
          v-hasPermi="['order:mpPurchaseOrder:add']"
        >新增毛坯采购订单</el-button>
        <el-button
          type="primary"
          icon="el-icon-edit"
          ...
          v-hasPermi="['order:mpPurchaseOrder:edit']"
        >修改</el-button>
        <el-button
          type="danger"
          size="small"
          :disabled="!isSingle"
          @click="deleteOrder"
          v-hasPermi="['order:mpPurchaseOrder:delet']"
        >删除</el-button>
        <!-- <el-button
          type="primary"
          size="small"
        ...
        >excel导出</el-button> -->
        <ty-export
          v-hasPermi="['order:mpPurchaseOrder:export']"
          size="small"
        ...
        <el-button
          ...
          size="small"
          @click="hiddenOrder"
          v-hasPermi="['order:mpPurchaseOrder:hidden']"
        >隐藏已完成订单</el-button>
      </div>
