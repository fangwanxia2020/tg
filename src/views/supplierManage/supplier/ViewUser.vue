  ...
  <div class="main">
    ...
    <div class="fan">
      ...
      <el-button
        ...
        v-if="status==1"
        v-hasPermi="['supplier:list:deactivate']"
      >禁用账号</el-button>
      <el-button
        type="primary"
        style="float: right;"
        ...
        @click="enableAccount"
        v-else
        v-hasPermi="['supplier:list:isdeactivate']"
      >启用账号</el-button>
    </div>
    <el-tabs
    ...
    >
      ...
      >
        <ty-business-crud
          ...
          :showSearchFields="['typeId','materialCode','materialName']"
          title=""
          :showOperation=[]
          :showIndex="true"
...
import EnterpriseOrder from "./details/EnterpriseOrder.vue";
export default ({
  components: {
    EnterpriseInfo,
    EnterpriseQua,
  ...
  created() {
    this.supplierId = this.$route.query.supplierId ? this.$route.query.supplierId : 0;
    this.init();
