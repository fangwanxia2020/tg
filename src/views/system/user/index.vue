        ...
        >
          ...
          <el-form-item>
            ...
            <el-button
              ...
              size="mini"
              @click="resetQuery"
              v-hasPermi="['system:user:listReset']"
            >重置</el-button>
          </el-form-item>
        </el-form>
...
export default {
  ...
  created() {
    if (this.$store.state.user.roles[0] == "role_supplier") {
      ...
      this.span = 24;
      if (this.$store.state.user.orgManager == 0) {
  ...
  methods: {
    ...
    getList() {
      ...
      listUser(this.addDateRange(sendData, this.dateRange)).then((response) => {
    ...
    handleResetPwd(row) {
      ...
      this.$prompt('请输入"' + row.userName + '"的新密码', "提示", {
        ...
        resetUserPwd(row.userId, this.$md5(value)).then((response) => {
